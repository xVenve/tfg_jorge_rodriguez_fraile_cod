...
def main():
    ...
    time.sleep(20)
    while True:
        co_level = readadc(mq7_apin, SPICLK, SPIMOSI, SPIMISO, SPICS)
        ...
        if GPIO.input(mq7_dpin):
            ...
            print("Current CO AD value = " + str("%.2f" % ((co_level / 1024.) * 5)) + " V")
            print("Current CO density is:" + str("%.2f" % ((co_level / 1024.) * 100)) + " %")
            time.sleep(0.5)
